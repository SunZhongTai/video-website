	...
	<div id="wrapper">
		...
		<div class="sidebar-collapse">
			<ul class="nav" id="main-menu">
				...
				<li><a href="/PIMS_struts2_hibernate/page/admin/sendEmail.jsp"
					class="active-menu"><i class="fa glyphicon glyphicon-envelope"></i> 发送邮件</a></li>
			</ul>
		</div>
		</nav>
		<!-- /. NAV SIDE  -->
								...
								<div class="table-responsive">
									...
									<s:form action="sendEmail" method="post">
										<div class="form-group">
											<label>选择接收者</label>
											<div class="table-responsive">
												<table class="table table-hover" name="example" id="example">
													<thead>
														<tr>
															<th>选择</th>
															<th>用户名</th>
													...
													<tbody>
														<s:iterator value="#session.users" var="uu">
															<div>
																<tr>
																	<td><input type="checkbox" name="check"
																		value="<s:property value='#uu.id'/>"></input></td>
																	<td><s:property value="#uu.username" /></td>
																	<td><s:property value="#uu.email" /></td>
																</tr>
															</div>
														</s:iterator>
													</tbody>
											...
											<div class="form-group">
												<input class="form-control" name="title" placeholder="添加标题">
											</div>
											<textarea class="form-control" id="editor_id" name="content"
												type="textarea" rows="10" autocomplete="off"
												validateevent="true" style="resize:none;"></textarea>
											<div style="text-align:center">
												<input class="btn btn-primary" value="群发" type="submit" /></input>
											</div>
										</div>
									</s:form>
