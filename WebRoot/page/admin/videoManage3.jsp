	...
	<div id="wrapper">
		...
		<div class="sidebar-collapse">
			<ul class="nav" id="main-menu">
				...
				<li><a href="/PIMS_struts2_hibernate/page/admin/videoManage.jsp" ><i
					...
					<ul class="nav nav-second-level">
						...
						<li><a
							href="/PIMS_struts2_hibernate/page/admin/videoManage3.jsp" class="active-menu">审核未通过</a></li>
					</ul></li>
